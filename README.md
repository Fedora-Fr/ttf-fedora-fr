# TTF Fedora-Fr based on Twenty Twenty Five
...
1. Download or clone this repository into the `wp-content/themes/` folder of your WordPress installation.
2. Activate the "TTF Fedora-Fr" theme from the WordPress admin (Appearance > Themes).
3. Customize the theme via the full site editor.
